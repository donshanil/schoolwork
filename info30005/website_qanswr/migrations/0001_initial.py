...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'website_qanswr.citation': {
            'Meta': {'object_name': 'Citation', '_ormbases': [u'website_qanswr.TextContent']},
            'text': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
            'textContent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'citation_for_answer'", 'to': u"orm['website_qanswr.TextContent']"}),
            u'textcontent_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['website_qanswr.TextContent']", 'unique': 'True', 'primary_key': 'True'})
        },
