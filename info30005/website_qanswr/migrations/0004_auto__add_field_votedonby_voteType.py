...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VotedOnBy.voteType'
        db.add_column(u'website_qanswr_votedonby', 'voteType',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VotedOnBy.voteType'
        db.delete_column(u'website_qanswr_votedonby', 'voteType')
    ...
    models = {
        ...
        u'website_qanswr.votedonby': {
            ...
            'textContent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['website_qanswr.TextContent']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'voteType': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True'})
        }
    }
